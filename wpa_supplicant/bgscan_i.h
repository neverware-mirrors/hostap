 ...
 *
 * rssi_threshold: Signal strength threshold for generating CQM events.
 ...
 *     options to the algorithm and then adjusted based on the current
 *     noise floor.
 * headroom: RSSI for generating CQM events.  headroom is calculated at
 *     initialization from the user-specified signal strength and then used
 *     to calculate rssi_threshold using the current noise floor.
 ...
 * txrate_threshold: Transmit rate threshold value.
 */
